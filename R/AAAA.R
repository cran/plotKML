...
paths <- function(gdalwarp = "", gdal_translate = "", convert = "", saga_cmd = "", python = "", gdal.dir = shortPathName("C:\\Program Files\\GDAL"), show.paths = TRUE){ 
    ...
    if(show.paths){ 
      message(paste("Located GDAL from the path: \"", fw.dir, "\"", sep="")) 
    }
    }
    else { 
